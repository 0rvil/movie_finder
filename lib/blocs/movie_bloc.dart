...
class MovieBloc {
  ...
  late StreamController<Response<List<Movie>>?> _movieListController;

  StreamSink<Response<List<Movie>>?> get movieListSink => _movieListController.sink;
  Stream<Response<List<Movie>>?> get movieListStream => _movieListController.stream;
